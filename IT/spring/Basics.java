 ...
 * Библиотека - представляет набор вспомогательных классов и методов, которые используются для дополнения приложения.
 * Фреймворк - это как каркас приложения, структура. Фреймворк навязывает как будет выглядеть приложение.
 */
